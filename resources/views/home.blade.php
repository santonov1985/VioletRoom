                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="page__tape">
                            ...
                            <div class="page__tape-icon">
                                <img src="{{ asset('img/value.png') }}" width="100%">
                            </div>
                            <div class="page__tape--dot-col"></div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="page__tape">
                            <div class="page__tape--dot-col"></div>
                            <div class="page__tape-icon">
                                <img src="{{ asset('img/start.png') }}" width="100%">
                            </div>
                            <div class="page__tape--dot-col"></div>
                        </div>
                        <div class="page__content-advantage">
                    ...
                    <div class="col-lg-3">
                        <div class="page__tape">
                            <div class="page__tape--dot-col"></div>
                            <div class="page__tape-icon">
                                <img src="{{ asset('img/favorites.png') }}" width="100%">
                            </div>
                            <div class="page__tape--dot-col"></div>
                        </div>
                        <div class="page__content-advantage">
                    ...
                    <div class="col-lg-3">
                        <div class="page__tape">
                            <div class="page__tape--dot-col"></div>
                            <div class="page__tape-icon">
                                <img src="{{ asset('img/sleep.png') }}" width="100%">
                            </div>
                            <div class="page__tape--dot-col"></div>
                        </div>
                        <div class="page__content-advantage">
